...
- **한 줄 요약**: 이 시스템은 **아웃바운드 PII 유출(OWASP LLM02) 방어에 특화**된 DLP 게이트웨이다. 프롬프트 인젝션·탈옥(LLM01)은 **현재 범위 밖**이며 §4·§7에 명시한다.
...
|---|---|---|
| 프롬프트 인젝션 / 탈옥 | LLM01 | 이 프로젝트는 **DLP(유출 방지)** 에 초점. 인젝션 탐지 레이어는 로드맵 R2 |
